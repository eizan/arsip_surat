...
{
    // default connection
    public static $dbname = 'arsip_surat'; // Your database name
    ...
    // theme and language
    public static $theme = 'joomla_new'; // can be 'default', 'bootstrap', 'minimal' or your custom. Theme of xCRUD visual presentation. For using bootstrap you need to load it on your page.
